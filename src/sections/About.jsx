    ...
    <section id="about" className="py-20 px-6 bg-gray-900">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 leading-relaxed text-justify">
          Saya adalah lulusan D3 Rekayasa Perangkat Lunak Aplikasi Telkom University dengan minat pada backend development, berpengalaman dalam pengembangan logika aplikasi, integrasi database, dan API. Berkomitmen untuk menerapkan
