...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen pt-24 flex items-center justify-center px-6 bg-gray-950">
      <div className="max-w-5xl w-full grid md:grid-cols-[1fr_1.4fr] gap-10 items-center">
        ...
        <div className="flex justify-center fade-up fade-delay-1">
          <img src={profileImg} alt="Muh Zayyan Al Thaaf Nur" className="w-40 h-40 md:w-56 md:h-56 rounded-full object-cover border-4 border-blue-500" />
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center md:justify-start fade-up fade-delay-4">
            <a href="#projects" className="px-6 py-3 bg-blue-500 rounded-lg hover:bg-blue-600 transition">
              Lihat Project
            </a>

            <a href="#contact" className="px-6 py-3 border border-gray-600 rounded-lg hover:border-blue-500 transition">
              Hubungi Saya
            </a>
          </div>
        </div>
